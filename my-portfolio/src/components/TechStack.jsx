                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
                    {[
                        ...
                        <div key={idx} className={`p-8 md:p-10 rounded-[2rem] md:rounded-[3rem] border group transition-colors duration-300 ${theme.colors.iconBg} ${theme.colors.border} hover:${theme.colors.accentBorder}`}>
                            <div className={`w-12 h-12 rounded-xl flex items-center justify-center shadow-sm mb-8 transition-all group-hover:${theme.colors.primaryBg} group-hover:text-white ${isDark ? 'bg-slate-800' : 'bg-white'} ${theme.colors.primary}`}>
