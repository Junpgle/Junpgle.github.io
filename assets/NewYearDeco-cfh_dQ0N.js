import{j as e}from"./index-D5L2Aau_.js";import{r as l}from"./icons-BOAska8y.js";import"./vendor-Dh3zDKDA.js";const f=({isDark:r})=>{const o=typeof window<"u"&&window.innerWidth<768,s=o?6:15,d=l.useMemo(()=>Array.from({length:s}).map((a,i)=>{const t=["#fbbf24","#f59e0b","#ef4444","#dc2626"];return{id:i,left:Math.random()*100+"%",top:Math.random()*80+5+"%",color:t[Math.floor(Math.random()*t.length)],delay:Math.random()*5+"s",duration:Math.random()*2+3+"s",scale:o?Math.random()*.3+.5:Math.random()*.5+.8}}),[o]);return e.jsxs("div",{className:"fixed inset-0 z-0 overflow-hidden pointer-events-none",children:[e.jsx("style",{children:`
